#!/usr/bin/env python3
# ----------------------------------------------------------------------------
# converts animation file to frames - riq
# ----------------------------------------------------------------------------
"""
Quick hack... running out of time
"""
import argparse
import os
import sys
...
formats = {}
formats[4] = BIOSFormat(48, 16, 4, 2)        # 320 x 200 4 colors
formats[6] = BIOSFormat(48, 16, 2, 2)        # 640 x 200 2 colors
formats[8] = BIOSFormat(48, 16, 16, 2)       # 160 x 200 16 colors
formats[9] = BIOSFormat(48, 16, 16, 4)       # 320 x 200 16 colors
formats[10] = BIOSFormat(48, 16, 4, 4)       # 640 x 200 4 colors
...
def write_to_file(lines, out_fd, gfx_format):
    ...
    #FIXME: hardcoded
    # a list of 6 lists. one per frame
    frames = [[],[],[],[],[],[]]
